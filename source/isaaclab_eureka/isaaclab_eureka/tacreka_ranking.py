...
class Tacreka_Ranking:
    ...
    def __init__(
        ...
        Args:
            ...
            num_reward_seeds: The number of environment seeds used to evaluate each reward.
        ...
        self._num_reward_seeds = max(1, int(num_reward_seeds))
    ...
    def run(self, max_eureka_iterations: int):
        ...
        for iter in range(max_eureka_iterations):
            ...
            if assistant_prompt is None:
                ...
                feature_gen_outputs_human_feedback = self._llm_manager.feature_gen(user_prompt=feature_gen_prompt + ranking_refinement_prompt, assistant_prompt=assistant_prompt, num_suggestion=2)
                ...
                feature_gen_outputs["raw_outputs"] = feature_gen_outputs_human_feedback["raw_outputs"] + feature_gen_outputs_explore["raw_outputs"]
                feature_gen_outputs["feature_strings"] = feature_gen_outputs_human_feedback["feature_strings"] + feature_gen_outputs_explore["feature_strings"]
                feature_strings = feature_gen_outputs["feature_strings"]
                print(f"feature_strings: {feature_strings}")
